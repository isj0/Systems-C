...
int main(void) {
    ...
    if (depHr == 0)
        printf("Closest departure time is 12:%02d AM", depMin);
    else if (depHr < 12)
        printf("Closest departure time is %d:%02d AM", depHr, depMin);
    else if (depHr == 12)
        printf("Closest departure time is 12:%02d PM", depMin);
    else
        printf("Closest departure time is %d:%02d PM", depHr - 12, depMin);

    if (arrHr == 0)
        printf(", arriving at 12:%02d AM\n", arrMin);
    else if (arrHr < 12)
        printf(", arriving at %d:%02d AM\n", arrHr, arrMin);
    else if (arrHr == 12)
        printf(", arriving at 12:%02d PM\n", arrMin);
    else 
        printf(", arriving at %d:%02d PM\n", arrHr - 12, arrMin);
